...
//   console.log(t("blog-content.sidebar.title"))
...
//             {t("blog-content.sidebar.title")}
            
//           </h3>

//           <p className="text-sm leading-relaxed text-gray-600">
//             {t("blog-content.sidebar.description")}
//           </p>
//         </div>
...
//             {t("blog-content.sidebar.categories")}
//           </h3>
...
//                 `}
//               >
//                 {t(`blog-content.categories.${post.slug}.title`)}
